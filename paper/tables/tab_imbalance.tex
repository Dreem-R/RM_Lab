...
None + isotonic & 0.674 & 0.211 & 0.095 & 0.005 & 0.112 & 23.2 \\
\noalign{\smallskip}\hline
\end{tabular}
\\[2pt] {\footnotesize Identical LightGBM configuration throughout; only the treatment of the class distribution changes. The observed event rate in the test set is 0.113.}